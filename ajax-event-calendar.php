<?php
/*
Plugin Name: Ajax Event Calendar [Main]
...
if (!class_exists('ajax_event_calendar')) {
	class ajax_event_calendar {
        ...
        function get_venue_info()
		{
			...
			$sql = "SELECT venue_id, venue_name FROM $table";
		...
		function install() {
			...
			if ($wpdb->get_var('SHOW TABLES LIKE "' . $wpdb->prefix . AEC_VENUE_TABLE . '"') != $wpdb->prefix . AEC_VENUE_TABLE) {
				$sql = 'CREATE TABLE ' . $wpdb->prefix . AEC_VENUE_TABLE . ' (
						...
						CHARSET=utf8;
						##DEFAULT VENUES
						INSERT INTO ' . $wpdb->prefix . AEC_VENUE_TABLE . ' (venue_id, venue_name, street, city, state, zip, website) VALUES  (NULL, "Blue Lagoon", "RIVERSIDE", "Sligo", "Ireland", "TT567", "www.wordpress.com"),
						(NULL, "Cafe Grappa", "Rockwood Parade", "Sligo", "Ireland", "TT567", "Sligo.ie"),
                        (NULL, "Shennanigans", "Bridge Street", "Sligo", "Ireland", "TT567", "Sligo.ie"),
						(NULL, "Calry Church", "The Mall", "Sligo", "Ireland", "TT567", "calrychurch.ie");';
